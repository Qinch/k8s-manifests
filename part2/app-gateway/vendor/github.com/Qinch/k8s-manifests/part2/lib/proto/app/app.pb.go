...
const file_app_app_proto_rawDesc = "" +
	"\n" +
	"\rapp/app.proto\x12\x03app\x1a\x1cgoogle/api/annotations.proto\"\"\n" +
	...
	"\n" +
	"AppService\x12K\n" +
	"\bSayHello\x12\x11.app.HelloRequest\x1a\x12.app.HelloResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/api/v1/sayhelloB4Z2github.com/Qinch/k8s-manifests/part2/lib/proto/appb\x06proto3"

var (
	file_app_app_proto_rawDescOnce sync.Once
	file_app_app_proto_rawDescData []byte
)

func file_app_app_proto_rawDescGZIP() []byte {
	file_app_app_proto_rawDescOnce.Do(func() {
		file_app_app_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_app_app_proto_rawDesc), len(file_app_app_proto_rawDesc)))
	})
...
var file_app_app_proto_depIdxs = []int32{
	...
	1, // 1: app.AppService.SayHello:output_type -> app.HelloResponse
...
func file_app_app_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_app_app_proto_rawDesc), len(file_app_app_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
